    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            ...
            if(convertView == null){
                ...
                holder.caption = (TextView) convertView.findViewById(R.id.cardCaption);
                holder.coordinates = (TextView) convertView.findViewById(R.id.cardCoor);
//                holder.lat = (TextView) convertView.findViewById(R.id.cardLat);
//                holder.lon = (TextView) convertView.findViewById(R.id.cardLon);
                holder.time = (TextView) convertView.findViewById(R.id.cardTime);
...
//            result.startAnimation(animation);
            ...
            holder.coordinates.setText("Location: (" + lat + ", " + lon + ")");
